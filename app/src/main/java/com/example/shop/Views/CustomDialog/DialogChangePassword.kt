package com.example.shop.Views.CustomDialog
...
import com.example.shop.Utils.IDUSER
import com.example.shop.Utils.PREF_NAME
import com.example.shop.Utils.TOKENUSER
...
class DialogChangePassword {
    ...
    fun EditProfil(Token:String, ID:String, Nom:String, Email:String, Bio:String, Password:String, context: Context, dialog: Dialog)
    {
        ...
        /////////////////////////////////////////////////////////////////////////////////////////////////////
        service.UpdatePassword(map).enqueue(object : Callback<JsonObject> {
